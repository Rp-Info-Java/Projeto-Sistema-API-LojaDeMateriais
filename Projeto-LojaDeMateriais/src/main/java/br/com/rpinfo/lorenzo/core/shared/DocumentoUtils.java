package br.com.rpinfo.lorenzo.core.shared;
...
public final class DocumentoUtils {
    ...
    //Validação para quando a movimentação está cancelada ou não
    ...
    //Validação da movimentação para quando o fornecedor está impedido ou não
