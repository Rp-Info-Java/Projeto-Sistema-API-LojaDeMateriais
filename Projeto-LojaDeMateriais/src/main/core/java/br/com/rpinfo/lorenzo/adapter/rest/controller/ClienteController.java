...
public class ClienteController {
    ...
    public Response insertCliente(@PathVariable String version, @RequestBody ClienteDto cliente) throws SQLException{
        return ClienteUseCase.inserirCliente(cliente, MethodVersion.fromValue(version));
    }

    @GetMapping("/{version}/cliente/getList")
    public Response getListClientes(@PathVariable String version) throws SQLException{
        return ClienteUseCase.getListaClientes(MethodVersion.fromValue(version));
    }

    @GetMapping("/{version}/{id}/cliente/getCliente")
    public Response getCliente(@PathVariable Integer id, @PathVariable String version) throws SQLException{
        return ClienteUseCase.getCliente(id, MethodVersion.fromValue(version));
    }

    @PutMapping("/{version}/cliente/update")
    public Response updateCliente(@PathVariable String version, @RequestBody ClienteDto cliente) throws SQLException{
