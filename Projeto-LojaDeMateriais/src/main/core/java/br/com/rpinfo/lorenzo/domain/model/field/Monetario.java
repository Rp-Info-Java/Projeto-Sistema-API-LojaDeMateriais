...
public class Monetario extends EntityFieldShort implements Serializable {
    ...
    public Monetario(Boolean autoEnabled) {
        super(autoEnabled);
        this.currency = new Currency();
        this.currency.setDecimals(Integer.valueOf(2).byteValue());
        this.setDataType(Types.FieldType.BigDecimal);
    }

    public Monetario(double value) {
        this();
        this.setValue(value);
    }

    public Monetario(BigDecimal value) {
        this(value.doubleValue());
    }

    public Monetario(Currency value) {
        this(value.getValue());
    }

    public Monetario(Monetario value) {
        this(value.getValue());
    }
    ...
    public Monetario setValue(BigDecimal value) {
        this.setValue(value.doubleValue());
        return this;
    }

    public Monetario setValue(Monetario value) {
