...
public class RelatoriosController {
    ...
    public Response getEntradas(@PathVariable String version) throws Exception {
        return RelatoriosUseCase.getEntradas(MethodVersion.fromValue(version));
    }

    @GetMapping("/{version}/relatorios/saidas")
    public Response getSaidas(@PathVariable String version) throws Exception {
        return RelatoriosUseCase.getSaidas(MethodVersion.fromValue(version));
    }

    @GetMapping("/{version}/relatorios/canceladas")
    public Response getCanceladas(@PathVariable String version) throws Exception {
